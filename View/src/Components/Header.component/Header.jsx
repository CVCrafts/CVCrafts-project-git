    ...
    <div className="relative z-10">
      ...
      >
        ...
        <nav className="flex space-x-6 items-center">
          <Link
            class="cursor-pointer appearance-none touch-manipulation items-center justify-center outline-none hover:opacity-80 px-7 py-2 rounded-full font-extrabold h-10 text-[15px] min-w-[120px] text-primaryBlack border-4 border-solid border-buttonGray hidden md:flex"
            to={"/resume"}
          >
            Try for free
            <span class="flex items-center justify-center ml-2 -mr-1 md:ml-3 md:-mr-[6px]">
              <div class="w-[18px] h-[18px] text-white bg-gradient-to-r from-brandPink to-brandRed rounded-full flex items-center justify-center">
                <svg
