		...
		<div className="max-w-md w-full space-y-8">
			<form className="mt-8 space-y-6" method="POST">
				<div className="rounded-md shadow-sm -space-y-px">
					<div>
						<label for="certificateName" className="sr-only">Certificate Name</label>
						<input onChange={this.SaveChange} value={this.state.certificateName} id="certificateName" name="certificateName" type="text" autocomplete="off" className="appearance-none mb-1 rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:border-transparent focus:ring-transparent focus:z-10 sm:text-sm" placeholder="Certificate Name"/>
					</div>
					<div>
						<label for="certificateDescription" className="sr-only">Description</label>
						<input onChange={this.SaveChange} value={this.state.certificateDescription} id="certificateDescription" name="certificateDescription" type="text" autocomplete="off" className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:border-transparent focus:ring-transparent focus:ring-red-500 focus:border-red-500 focus:z-10 sm:text-sm" placeholder="Certificate Description"/>
					</div>
				</div>
