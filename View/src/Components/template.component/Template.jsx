        ...
        <section className="bg-lightGray">
          <div className="landingPageContainer pt-18 px-8 pb-24">
            <div className="flex flex-col lg:items-center">
              <h2 class="text-3xl xl:text-4xl font-extrabold text-strong">
                Free CVs templates
              </h2>
              <p class="max-w-full mt-4 leading-relaxed md:text-xl">
              ...
              <div className="mt-8 md:mt-9 lg:mt-10 w-full m-w-[1200px]">
                <div>
                  <div
                    class="lazy grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 justify-center gap-x-8 entered"
                    data-lazy-function=""
