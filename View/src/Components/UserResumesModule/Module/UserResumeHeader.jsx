      ...
      <div className="bg-homeBackgroundColor px-6 pt-0 pb-2 sm:px-8 md:px-10 md:pb-4 lg:px-12 lg:pb-6 xl:px-14">
        <div className="flex w-full items-center justify-between">
          ...
          <div className="flex w-auto items-center space-x-3 sm:space-x-6">
            <button
              type="button"
              className="border-none cursor-pointer appearance-none touch-manipulation flex items-center justify-center outline-none hover:opacity-80 px-7 py-2 rounded-full font-extrabold h-10 text-[15px] min-w-[120px] text-white bg-primaryBlack"
              onClick={() => {
                isLoginLogoutNowFuncation();
              }}
            >
              {!isAuthenticated ? "Login" : "Logout"}
              <span className="flex items-celect>enter justify-center ml-2 -mr-1 md:ml-3 md:-mr-[6px]">
                <svg
